...
class BookItem(scrapy.Item):
    ...
    thumbnailUrl = Field(input_processor=MapCompose(json_field_extractor_v2('props.pageProps.apolloState.Book*.imageUrl')))
    ...
    isbn_10 = Field(input_processor=MapCompose(json_field_extractor_v2('props.pageProps.apolloState.Book*.details.isbn')))
    ...
    publish_date = Field(input_processor=MapCompose(json_field_extractor_v2('props.pageProps.apolloState.Book*.details.publicationTime')))
    ...
    author_name = Field(input_processor=MapCompose(json_field_extractor_v2('props.pageProps.apolloState.Contributor*.name')), output_processor=Compose(set, list))
    ...
    num_pages = Field(input_processor=MapCompose(json_field_extractor_v2('props.pageProps.apolloState.Book*.details.numPages')))
    ...
    author_id = Field()
    edition_Unique_Id = Field(input_processor=MapCompose(json_field_extractor_v2('props.pageProps.apolloState.Work*.editions.webUrl'), lambda url: url.split('/')[-1]))
...
class AuthorItem(scrapy.Item):
    ...
    worksCount = Field(serializer=int)
